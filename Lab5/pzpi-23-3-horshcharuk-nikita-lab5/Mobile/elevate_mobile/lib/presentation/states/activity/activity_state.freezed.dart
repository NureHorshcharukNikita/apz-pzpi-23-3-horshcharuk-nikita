...
mixin _$ActivityState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Activity> activity) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Activity> activity)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Activity> activity});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<Activity> activity) : _activity = activity;
...
abstract class _Loaded implements ActivityState {
  const factory _Loaded(final List<Activity> activity) = _$LoadedImpl;
