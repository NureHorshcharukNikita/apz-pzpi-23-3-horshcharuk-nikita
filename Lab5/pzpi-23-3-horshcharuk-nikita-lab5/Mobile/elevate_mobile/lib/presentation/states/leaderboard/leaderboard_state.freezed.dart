...
mixin _$LeaderboardState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<LeaderboardUser> users) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<LeaderboardUser> users)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<LeaderboardUser> users) : _users = users;
...
abstract class _Loaded implements LeaderboardState {
  const factory _Loaded(final List<LeaderboardUser> users) = _$LoadedImpl;
