...
namespace Hardware {
    ...
    constexpr int BUTTON_SCAN = 32;
    constexpr int BUTTON_LEADERBOARD = 33;
    constexpr int BUTTON_STATS = 25;
    constexpr int BUTTON_SETTINGS = 26;
    constexpr int BUTTON_BACK = 27;
    constexpr int BUTTON_POWER = 14;
}
...
namespace Timing {
    ...
    constexpr unsigned long SCAN_RESULT_DISPLAY_MS = 7500;
...
namespace Config {
    ...
    constexpr const char* API_BASE_URL = "http://192.168.0.77";
