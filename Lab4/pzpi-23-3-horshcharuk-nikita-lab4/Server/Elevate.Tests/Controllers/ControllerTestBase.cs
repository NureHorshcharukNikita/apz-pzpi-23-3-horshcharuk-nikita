...
public abstract class ControllerTestBase : IClassFixture<CustomWebApplicationFactory>
{
        ...
        string role = "User")
    {
        ...
        var webAdminOptions = tokenScope.ServiceProvider.GetRequiredService<IOptions<WebAdministrationOptions>>();
        ...
        var tokenService = new JwtTokenService(jwtOptions, webAdminOptions);
